...
for i, row in enumerate(c):
    ...
    h_dis.append(h_dis1)
h_mat = np.array(h_dis).reshape(1,-import numpy as np
pb = [] # Parity matrix
Ik = [] # I_K Matrix1)
...
<img width="666" height="835" alt="image" src="https://github.com/user-attachments/assets/9b3c8ec6-a6fd-44e3-a85e-c0ec8b3e1555" />
